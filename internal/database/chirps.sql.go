...
const getAllChirpsByDate = `-- name: GetAllChirpsByDate :many
SELECT id, created_at, updated_at, body, user_id
FROM chirps
ORDER BY created_at ASC
`

func (q *Queries) GetAllChirpsByDate(ctx context.Context) ([]Chirp, error) {
	rows, err := q.db.QueryContext(ctx, getAllChirpsByDate)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
